...
def make_ingress(name, ingress, routespec, target, labels, data):
    """
    ...
    try:
        ...
        try:
            ...
            from kubernetes.client.models import (
                V1beta1Ingress as V1Ingress,
                V1beta1IngressSpec as V1IngressSpec,
                V1beta1IngressRule as V1IngressRule,
